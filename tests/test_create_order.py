...
class TestCreateOrder:
    ...
    @allure.description('Проверка получения ответа 200 при создании заказа без авторизации. Токен аккаунта не '
                        'передается.')
    def test_create_order_unauthenticated_user_success(self):
    ...
    def test_create_order_invalid_ingredients_authenticated_user_expected_error(self):
